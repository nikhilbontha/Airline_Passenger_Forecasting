# RNN and LSTM models require sequential input data because they capture temporal dependencies. We use a sequence generator to transform the time-series data into fixed-length input sequences and corresponding target values. These generated sequences are then fed into the model for training, allowing it to learn from historical patterns and forecast future values.
