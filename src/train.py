# The model is trained on the training dataset to learn patterns from the data. After training, it is tested on the testing dataset to evaluate its performance and prediction accuracy.
